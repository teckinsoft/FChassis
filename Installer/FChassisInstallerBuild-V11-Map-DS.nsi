...
Function .onInstSuccess
  ...
  ; Map W: drive to the cached LOCALAPPDATA
  !insertmacro LogVar "Mapping W: drive to LOCALAPPDATA" $UserLocalAppDataDir
  
  ; Always delete existing W: drive mapping first
  !insertmacro LogMessage "Deleting existing W: drive mapping..."
  ExecWait 'net use W: /delete /y'
  
  ; Create new persistent mapping
  !insertmacro LogMessage "Creating new persistent mapping..."
  ExecWait 'net use W: "$UserLocalAppDataDir" /persistent:yes'
  
  !insertmacro LogMessage "Drive mapping completed: W:\ now points to $UserLocalAppDataDir"
FunctionEnd
