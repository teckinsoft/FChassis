...
; startmenu_failed:
  ; !insertmacro LogError "Failed to create Start Menu shortcut"
  ; ; Optional: Try an alternative with explicit icon index 0 from the exe
...
sm_dir_done:
  ...
  Pop $0
  ${If} $0 != 0
    !insertmacro LogError "Failed to remove $INSTDIR\thirdParty\OpenCASCADE-7.7.0-vc14-64\tbb-2018.2.1-vc14-64\bin from PATH, error code: $0"
  ${Else}
    !insertmacro LogMessage "Successfully removed $INSTDIR\thirdParty\OpenCASCADE-7.7.0-vc14-64\tbb-2018.2.1-vc14-64\bin from PATH"
  ${EndIf}
