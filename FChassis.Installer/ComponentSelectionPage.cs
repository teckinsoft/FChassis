...
public partial class ComponentSelectionPage : ComponentPage {
   ...
   void initComponents () {
      // Create DataMApping Page and Component
      var dataMappingPage = new DataFolderMappingPage ();
      var dataMapping = new DataFolderMapping () {
         page = dataMappingPage
      };

      dataMappingPage.component = dataMapping;
      ...
      this.componentTreeNodes = new TreeNode[] {
         new TreeNode {
            Text = "Dot Net 8.0",
            Tag = new InstallDotNet()
         },
         new TreeNode {
            Text = "Flux SDK.4 Setup",
            Tag = new InstallFluxSDK(),
         },
         new TreeNode {
            Text = "OpenCascade 7.5.0",
            Tag = new InstallOpenCascade ()
         },
         new TreeNode {
            Text = "FChassis Installation",
            Tag = new InstallFChassis ()
         },
         new TreeNode {
